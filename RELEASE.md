...
Placeholder for `conda-content-trust ` release.
...
- [ ] Ensure release candidates are being successfully built (see `conda-canary/label/rc-conda-content-trust-`)
...
Once the release PRs are filed, successful canary builds will be available on `/conda-content-trust/files?channel=rc-conda-content-trust-` for manual testing.
