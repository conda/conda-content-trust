...
[epic template]: https://github.com/conda/conda-content-trust/issues/new?assignees=&labels=epic&template=epic.yml
[compare]: https://github.com/conda/conda-content-trust/compare
[new release]: https://github.com/conda/conda-content-trust/releases/new
...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/conda-content-trust-feedstock
[conda-forge]: https://github.com/conda-forge/conda-content-trust-feedstock
...
Placeholder for `conda-content-trust MAJOR.MINOR.x` release.
...
[milestone]: https://github.com/conda/conda-content-trust/milestone/<milestone>
[process]: https://github.com/conda/conda-content-trust/blob/main/RELEASE.md
[releases]: https://github.com/conda/conda-content-trust/releases
[main]: https://github.com/AnacondaRecipes/conda-content-trust-feedstock
[conda-forge]: https://github.com/conda-forge/conda-content-trust-feedstock
[ReadTheDocs]: https://readthedocs.com/projects/continuumio-conda-content-trust/
...
- [ ] Ensure release candidates are being successfully built (see `conda-canary/label/rc-conda-content-trust-MAJOR.MINOR.x`)
...
2. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    (rever) $ git clone git@github.com:/conda-content-trust.git
    (rever) $ cd conda-content-trust
    ```
...
To publish the release, go to the project's release page (e.g., https://github.com/conda/conda-content-trust/releases) and add the release notes from `CHANGELOG.md` to the draft release you created earlier. Then publish the release.
